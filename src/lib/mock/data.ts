...
export const mockBilling: BillingInfo = {
  ...
  currency: 'CLP',
  history: [
    { id: 'inv-001', date: daysAgo(15), amount: 49990, status: 'paid', invoiceUrl: '#' },
    { id: 'inv-002', date: daysAgo(45), amount: 49990, status: 'paid', invoiceUrl: '#' },
    { id: 'inv-003', date: daysAgo(75), amount: 49990, status: 'paid', invoiceUrl: '#' },
    { id: 'inv-004', date: daysAgo(105), amount: 29990, status: 'paid', invoiceUrl: '#' },
  ],
};
